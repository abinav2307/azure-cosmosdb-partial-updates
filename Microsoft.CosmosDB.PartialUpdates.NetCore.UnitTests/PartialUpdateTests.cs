...
namespace Microsoft.Azure.CosmosDB.PartialUpdates.NetCore.Tests
{
    public class PartialUpdateTests
    {
        ...
        private static int OfferThroughput = 1200;
            ...
            string partitionKeyDefinition = null)
        {
            ...
            string partitionKey = PartialUpdateTests.PartitionKeyName;
            ...
            return await client.CreateDocumentCollectionAsync(
                ...
                myCollection,
                new RequestOptions { OfferThroughput = PartialUpdateTests.OfferThroughput });
        }
